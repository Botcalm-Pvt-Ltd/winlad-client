...
const Gallery2 = () => {
  return (
    <div className="w-full bg-gallery">
      <div className="flex flex-col items-center w-full px-3 lg:px-5 py-16 gap-3">
        ...
        <p className="text-center text-base sm:text-lg 2xl:text-xl special:text-3xl font-bold ">
