    ...
    <div style={{ background: "black" }} className="md:pl-0">
      <div className="flex flex-col md:flex-row md:px-14">
        <div className="xl:w-2/3 md:w-1/2 w-full pl-4 pt-5 2xl:pt-10 lg:pl-0">
          ...
          <p
            className="text-sm mt-5 special:text-3xl"
            style={{ color: "#fff" }}
          >
        ...
        <div className="flex xl:w-1/3 md:w-1/2 w-full justify-between pb-2 linklist">
          <div className="m-5" style={{ color: "#fff" }}>
            <p className="font-bold mb-3 special:text-2xl">Links</p>
            <ul className="special:text-2xl">
              <li>Home</li>
              <li>Service</li>
              <li>Pricing</li>
              <li>About Us</li>
          ...
          <div className="m-5" style={{ color: "#fff" }}>
            <p className="font-bold mb-3 special:text-2xl">Product</p>
            <ul className="special:text-2xl">
          ...
          <div className="m-5" style={{ color: "#fff" }}>
            <p className="font-bold mb-3 special:text-2xl">Community</p>
            <ul className="special:text-2xl">
